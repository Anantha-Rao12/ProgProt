...
print(c1.processed_string)

c1_mat = c1.permute_matrix(lexical_sort=True)
...
print('Given BW string : ',ibwt_input)

print(c2.ibwt_matrix())

print('\nInverse Burrows Wheeler Transform:',c2.ibwt())
